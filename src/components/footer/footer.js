...
function Footer() {
    ...
    return (
        <div className='footer-wrapper'>
            <div>
                <a className='icon' href='https://www.instagram.com/anapatsuu?igsh=OGF4YWFpemxnMjVy'><i class="bi icon bi-instagram"></i></a>
                <a className='icon' href='https://www.threads.net/@anapatsuu'><i class="bi icon bi-threads"></i></a>
                <a className='icon' href='https://www.behance.net/anatodd'><i class="bi icon bi-behance"></i></a>
